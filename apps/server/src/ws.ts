  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverListExtensions]: (_input) =>
          observeRpcEffect(WS_METHODS.serverListExtensions, listExtensions(config), {
            "rpc.aggregate": "server",
          }),
        [WS_METHODS.serverCreateExtensionDraft]: (input) =>
          observeRpcEffect(
